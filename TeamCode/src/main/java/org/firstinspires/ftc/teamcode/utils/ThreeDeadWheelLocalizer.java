...
// Tutorial for tuning Roadrunner 1.0 - https://youtu.be/26ghjpkJwyM?si=bDOa5mJF-7CP6r7E

@Config
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 7.5; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 6.9; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 4.5; // x position of the perpendicular encoder (in tick units)
    }
