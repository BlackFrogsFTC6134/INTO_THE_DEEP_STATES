...
@TeleOp(name="Demo_BFR_LinearActuator_Without_Reset_Encoder", group="Demo")
public class BFR_Demo_LinearActuator_With_Reset_Encoder extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        linearActuator.setDirection(DcMotorEx.Direction.REVERSE);
        rotateActuator.setDirection(DcMotorEx.Direction.REVERSE);
